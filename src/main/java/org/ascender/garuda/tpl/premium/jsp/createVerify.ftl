...
<waf:html>
<head>
	<title>${entityName}CreateVerify</title>
	...
	<script language="javascript">
	    ...
	    function doReject() {
			var callback = function(message) {
				...
				generalSubmit(document.forms[0], './apiKeyCreateReject.do');
				};
	    ...
	    function initItems() {
	        ...
	        //audit
	        prepareAuditData(null, "APIKEY", document.forms[0].elements['voApiKey.apiId'].value);
	    }
	</script>
</head>
<body leftmargin="0" topmargin="0">
	<waf:form action="/apiKeyCreateSave.do" method="POST">
					...
					<td valign="top">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td class="info"><waf:label key="apiKey.apiKeyCreateTitle" /></td>
							...
							<table border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="button-space">
										<button id="btnApprove" class="appButton" type="button" title="<waf:label key='button.alt.approve'/>" 
												onclick="return doSubmit('./apiKeyCreateApprove.do');">
		...
		<waf:hidden property="voApiKey.message" />
