...
<head>
	...
	<script language="javascript" src="./resources/<waf:theme/>/js/note/note.js"></script>
	<script language="javascript">
	    ...
	    function doReject() {
			var callback = function(message) {
				...
				generalSubmit(document.forms[0], './apiKeyUpdateReject.do');
				};
					...
					<td valign="top">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td class="info"><waf:label key="api.apiKeyCreateTitle" /></td>
							...
							<table border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="button-space">
										<button id="btnApprove" class="appButton" type="button" title="<waf:label key='button.alt.approve'/>" onclick="return doSubmit('./apiKeyUpdateApprove.do');">
									...
									<tr>
										<td id="tabBody" class="appTabPanelBorder">
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td>
														<jsp:include page="include/apiKeyDualViewGeneral.jsp" flush="true"/>
														<jsp:include page="include/apiKeyDualViewRelation.jsp" flush="true"/>
													</td>
												</tr>
											</table>
										</td>
